...
import { Menu, X, Home, Layers, Briefcase, Mail, User, ChevronDown } from 'lucide-react';
...
const Navbar: React.FC<NavbarProps> = ({ 
  logoSrc = "https://api.dicebear.com/7.x/shapes/svg?seed=logo&backgroundColor=transparent&shape1Color=ffffff",
  brandName = "ModernUI"
}) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          `}>
            ...
            <a href="#" className="flex items-center gap-3 group">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-emerald-700/80 to-emerald-800/80 p-2.5 shadow-lg shadow-emerald-950/40 group-hover:shadow-emerald-900/50 transition-all duration-300">
                <img 
                  src={logoSrc}
                  alt="Logo" 
              ...
              <span className="text-lg sm:text-xl font-bold bg-gradient-to-r from-emerald-400/90 via-emerald-300/80 to-emerald-500/90 bg-clip-text text-transparent hidden sm:block">
                {brandName}
              </span>
            </a>
